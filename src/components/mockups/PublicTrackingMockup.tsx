  ...
  return (
    <div className="w-full relative animate-float-slow [zoom:0.45] sm:[zoom:0.65] lg:[zoom:0.8] xl:[zoom:1]" style={{ perspective: '1500px' }}>
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#3b82f6] rounded-xl shadow-[0_30px_60px_rgba(0,0,0,0.3)]" style={{ transform: 'translateZ(-6px)' }}></div>
        ...
        <div className="absolute inset-0 bg-[#f8fafc] rounded-xl border border-[#cbd5e1] overflow-hidden flex flex-col" style={{ transform: 'translateZ(0px)' }}>
          {/* Chrome */}
          <div className="h-8 bg-gradient-to-b from-white to-slate-100 flex items-center px-4 border-b border-slate-200">
            <div className="flex gap-1.5">
              <div className="w-2.5 h-2.5 rounded-full bg-[#ff5f56]"></div>
              <div className="w-2.5 h-2.5 rounded-full bg-[#ffbd2e]"></div>
              <div className="w-2.5 h-2.5 rounded-full bg-[#27c93f]"></div>
            </div>
            <div className="mx-auto bg-white/70 text-slate-800 text-[10px] font-mono px-12 py-0.5 rounded border border-slate-200 shadow-inner">
          ...
          <div className="flex-1 flex flex-col items-center justify-start p-6 relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-400/10 rounded-full blur-[40px] -z-10 transform translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-cyan-400/10 rounded-full blur-[40px] -z-10 transform -translate-x-1/2 translate-y-1/2"></div>
            ...
            <div className="w-full max-w-sm relative mb-8">
              <input 
                ...
                className="w-full h-12 pl-4 pr-12 rounded-xl border-2 border-blue-200 bg-white text-sm font-bold text-slate-700 shadow-sm focus:outline-none"
              />
              <div className="absolute right-2 top-2 bottom-2 w-8 bg-blue-600 rounded-lg flex items-center justify-center text-white shadow-md">
                <Search size={14} />
              </div>
            </div>

            {/* Tracking Result Card */}
            <div className="w-full max-w-md bg-white border border-slate-100 rounded-2xl p-5 shadow-lg shadow-blue-900/5 flex flex-col relative z-10">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <div className="text-[10px] font-bold text-blue-600 uppercase tracking-wider mb-1">NOC For Water Connection</div>
              ...
              {/* Timeline */}
              <div className="relative pl-4 space-y-4 before:absolute before:inset-0 before:ml-[23px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-emerald-400 before:via-blue-300 before:to-slate-200">
                ...
                {/* Step 3 */}
                <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  <div className="flex items-center justify-center w-4 h-4 rounded-full border-2 border-white bg-blue-400 shadow shrink-0 absolute left-0 z-10">
                    <div className="w-1.5 h-1.5 bg-white rounded-full animate-ping"></div>
                  </div>
                  <div className="ml-8 text-[11px] bg-blue-50 p-2 rounded border border-blue-100">
                    <h4 className="font-bold text-blue-700">Zone East Verification</h4>
                    <span className="text-[9px] text-blue-600/70">Currently with Site Engineer</span>
                  </div>
                </div>
